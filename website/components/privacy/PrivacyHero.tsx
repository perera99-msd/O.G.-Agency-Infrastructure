    ...
    <section className="relative w-full h-[55vh] min-h-[420px] flex items-end overflow-hidden bg-main-900">
      ...
      <div className="relative z-10 w-full px-6 md:px-16 lg:px-24 pb-12 md:pb-16">
        <div className="max-w-screen-xl mx-auto">
          ...
          >
            Your privacy matters to us. This policy explains how O.G. Agency collects, uses, stores, and protects your personal data when you use our recruitment services or visit our website.
          </motion.p>
        </div>
      </div>
    </section>
